<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<!DOCTYPE html>
<html lang="es" ng-app="correomasivoapp">
<head>
<!-- META SECTION -->
...
<body>
	...
	<div class="page-container">
		...
		<div class="page-content">
			...
			<div class="page-content-wrap" ng-controller="enviocorreoctrl">
				<div class="row">
					<div class="col-md-12">
						<form class="form-horizontal">
							<div class="panel panel-default">
								<div class="panel-heading">
									<h5 class="panel-title">Envio Masivo de Correo</h5>
								</div>
								<div class="panel-body">
									<div class="form-group">
										<label class="col-md-2 col-xs-12 control-label">Imagen</label>
										<div class="col-md-10 col-xs-12">
											<input type="file" class="form-control" ngf-select="" ng-model="archivo">
										</div>
									</div>
								</div>
								<div class="panel-body">
									<table class="table">
										<thead>
											<tr>
												...
												<th style="width: 29%; text-align: center;">Cliente</th>
												<th style="width: 30%; text-align: center;">Contacto</th>
												<th style="width: 30%; text-align: center;">Correo</h>
												<th style="width: 10%; text-align: center;">Enviar?</th>
											</tr>
										</thead>
										<tbody>
											<tr ng-repeat="item in listaFiltrada">
												<td style="width: 1%; text-align: center;"></td>
												<td style="width: 29%; text-align: left;">{{item.cliente.nombreCompleto}}</td>
												<td style="width: 30%; text-align: left;">{{item.contacto.nombreCompleto}}</td>
												<td style="width: 30%; text-align: left;">{{item.correoElectronico.direccion}}</td>
												<td style="width: 10%; text-align: center;"><input
													type="checkbox" ng-model="item.enviarCorreo"></td>
											</tr>
										</tbody>
										<tfoot>
											<tr>
								...
								<div class="panel-footer">
									<div class="row">
										<div class="col-md-12 col-xs-12">
											<button class="btn btn-primary" type="button" ng-click="enviarCorreos(archivo)">
												<span class="fa fa-download"></span>Enviar Correos
											</button>
										</div>
									</div>
								</div>
	...
	<script type="text/javascript"
		src="/RHViajes2/paginas/negocio/correomasivo/js/controlador.js"></script>
</body>
</html>