										...
										<tbody>
											<tr ng-repeat="item in listaFiltrada">
												...
												<td style="width: 5%; text-align: center;"><a href="#"
													ng-click=verDetalleComprobante(item.codigoEntero) data-toggle="modal" data-target="#modalDetalleComprobante"><span
														class="fa fa-file-text-o"></span></a></td>
											</tr>
										</tbody>
										<tfoot>
											<tr>
											...
											<div class="modal-content">
																				...
																				<table class="table">
																					...
																					<tbody>
																						<tr ng-repeat="item in detalle.detalle">
																							<td style="width: 2%; text-align: center;"><input type="checkbox" ng-model="item.flagImprimir"></td>
																							<td style="width: 8%; text-align: right;">{{item.cantidad}}</td>
																							<td style="width: 50%; text-align: left;">{{item.concepto}}</td>
																							<td style="width: 20%; text-align: right;">{{detalle.moneda.abreviatura}} {{item.precioUnitario | number : 2}}</td>
																							<td style="width: 20%; text-align: right;">{{detalle.moneda.abreviatura}} {{item.totalDetalle | number : 2}}</td>
																						</tr>
																					</tbody>
																				</table>
																			</div>
												...
												<div class="modal-footer">
													<button type="button" id="idbtnAgregarDireccion"
														class="btn btn-primary" ng-click="generaComprobanteImpresion()">Comprobante
														Impresión</button>
													<button type="button" id="idbtnAgregarDireccion"
														class="btn btn-primary" ng-click="generaComprobanteDigital()">Comprobante
														Digital</button>
